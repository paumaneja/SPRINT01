...
1. Obrir Terminal
2. Naveguem fins la carpeta del projecte creat a Intellij
3. Primer compilem:
...
4. Executem el programa indicant la ruta que volem mostrar ordenada (java package/nomdelaclasse ruta/relativa/diretori)
    Exemple: java N0101/SortedbyNameDirectory N0101
